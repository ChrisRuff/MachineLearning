                               ...
                               bool writeGraph)
{
	...
	auto dims_expander = ExapndDims(root.WithOpName("dim"), float_caster, 0);

	auto resized = ResizeBilinear(root.WithOpName("size"), dims_exapnder, Const(root, {input_height, input_width}));
	...
	if(writeGraph)
	{
		...
		TF_CHECK_OK(CreateSummaryFileWriter(1,0,"/home/chris/Documents/Git_Repos/MachineLearning/C++/Cat-Dog/graphs", ".img-graph", Env::Default(), &w));
...
{
	string image = "/home/chris/Documents/Git_Repos/MachineLearning/C++/Cat-Dog/data/grace_hopper.jpg";
	...
	cout << resized_tesnors[0].shape().DebugString() << endl;
	if(!read_tensor_status.ok())
	{
		LOG(ERROR) << read_tensor_status;
		return -1;
	}	
	Status write_tensor_status = WriteTensorToImageFile("/home/chris/Documents/Git_Repos/MachineLearning/C++/Cat-Dog/data/output.jpg", input_height, input_width, input_mean, input_std, resized_tensors);
	return 0;
}
